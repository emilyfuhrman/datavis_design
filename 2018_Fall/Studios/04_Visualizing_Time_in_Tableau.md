...
![Tableau Sample Data](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/01_Tableau_Sample_Data.png)

* Navigate down to the row that reads `Tour de France Statistics`.
* Download the Excel file.
* Open it up in Excel.

![Data in Excel](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/02_Data_in_Excel.png)
...
![Copy Tab](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/03_Copy_Tab.png)
...
![First Date](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/04_First_Date.png)
...
![Sort By](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/05_Sort_By.png)

* Click `OK`. The data should now be interspersed with the column of dates that you created.

![Sorted](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/06_Sorted.png)
...
![Remove Duplicates](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/07_Remove_Duplicates.png)

* Select the column that contains your duplicates. In this case, that is the `Year` column -- `Column A`.

![Column with Duplicates](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/08_Column_with_Duplicates.png)

* Click `OK`. The gaps in your dataset should now be filled out with blank rows.

![Filled Out](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/09_Filled_Out.png)
...
![Import Data](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/10_Import_Data.png)

* Once your data loads, you should see a preview that looks similar to what we viewed in Excel:

![Preview Data](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/11_Preview_Data.png)
...
![Year Alone](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/12_Year_Alone.png)
...
![Line Chart](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/13_Line_Chart.png)
...
![Line Chart Final](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/14_Line_Chart_Final.png)
...
![Average Speed Alone](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/15_Average_Speed_Alone.png)

* Now, drag `Total distance (km)` to the `Columns` shelf, to create an extremely simple scatterplot.

![Simple Scatterplot](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/16_Simple_Scatterplot.png)
...
![Change to Line](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/17_Change_to_Line.png)
...
![Drag to Path](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/18_Drag_to_Path.png)
...
![Edit Y-Axis](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/19_Edit_Y-Axis.png)

* The chart should scale accordingly. Now, do the same for the x-axis.

![Centered Data](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/20_Centered_Data.png)
...
![Colored by Country](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/21_Colored_by_Country.png)

* Click `Edit Colors...` to customize your category colors.

![Color Editor](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/22_Color_Editor.png)
...
![Final Scatter](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/24_Final_Scatter.png)
...
![Scatter Setup](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/25_Scatter_Setup.png)
...
![Scatter by Year](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/26_Scatter_by_Year.png)
...
![Color by Nationality](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/27_Color_by_Nationality.png)
...
![Size by Speed](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/28_Size_by_Speed.png)
...
![Customize Sizes](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/29_Customize_Sizes.png)
...
![Sizes by Range](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/30_Sizes_by_Range.png)
...
![Slide Sizes](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/31_Slide_Sizes.png)
...
![Axis Customization](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/32_Axis_Customization.png)
...
![Play by Year](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/33_Play_by_Year.png)
...
![Show History](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/34_Show_History.png)
...
![Animated Final](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/35_Animated_Final.png)
...
![First Bars](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/36_First_Bars.png)

* In the `Marks` dropdown, instead of `Automatic`, select `Line`.

![First Line](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/37_First_Line.png)
...
![Parallel All Bad](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/38_Parallel_All_Bad.png)
...
![Filtered Down](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/39_Filtered_Down.png)
...
![Select Calculated Field](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/40_Select_Calculated_Field.png)
...
![Field Formula](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/41_Field_Formula.png)
...
![Normalized Added](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/42_Normalized_Added.png)
...
![All Normalized Added](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/43_All_Normalized_Added.png)

* Extend the width of your chart.
* In the `Size` tile of the `Marks` panel, adjust the line width to be smaller.

![Thinner Lines](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/44_Thinner_Lines.png)
...
![Filter Nationality](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/45_Filter_Nationality.png)
...
![Parallel Coordinates Final](https://github.com/emilyfuhrman/datavis_design/blob/master/2018_Fall/Studios/Images/04/46_Parallel_Coordinates_Final.png)
